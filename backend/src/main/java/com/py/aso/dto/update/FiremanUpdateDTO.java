...
@Data
@ApiModel(description = "Objeto que representa a un bombero, utilizado para actualizar el objeto")
public class FiremanUpdateDTO {
	...
	@NotNull(message = "La fecha de nacimieneto del bombero es requerida")
	...
	@ApiModelProperty(notes = "Id de la ciudad donde se encuentra el Bomber", example = "5", required = true)
	private long cityId;
