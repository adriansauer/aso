...
@Data
@ApiModel(description = "Objeto que representa a una historia de una brigada, se utiliza para actualizar visualizar los detalles")
public class BrigadeHistoryDetailDTO {
