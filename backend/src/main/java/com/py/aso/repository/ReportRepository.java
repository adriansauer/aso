...
public interface ReportRepository extends JpaRepository<PublicationEntity, Long> {
	...
	public Long countByYearAndMonthAndCodeIdAndBrigadeIdAndDeletedAndEnabled(final Long year, final Long month, final Long codeId, final Long userId, final boolean deleted, final boolean enabled);
	...
	public Long countByYearAndCodeIdAndBrigadeIdAndDeletedAndEnabled(final Long year, final Long codeId, final Long userId, final boolean deleted, final boolean enabled);
	...
	public Long countByYearAndMonthAndUserIdAndDeletedAndEnabled(final Long year, final Long month, final Long userId, final boolean deleted, final boolean enabled);
	...
	public Long countByYearAndUserIdAndDeletedAndEnabled(final Long year, final Long userId, final boolean deleted, final boolean enabled);
	...
	public Long countByCodeIdAndMonthAndUserIdAndDeletedAndEnabled(final Long codeId, final Long month, final Long userId, final boolean deleted, final boolean enabled);
	...
	public Long countByCodeIdAndUserIdAndDeletedAndEnabled(final Long CodeId, final Long userId, final boolean deleted, final boolean enabled);
}
